...
- [ ] 3.实现玩家点击建筑能弹出UI并能点击其他位置关闭UI的功能（当玩家打开UI时，把selectedBuilding设置为null（即将已经选择的建筑变量设为空））

- [ ] 4.实现UI能够显示建筑是否正在运行，是否连接到主基地的功能

- [ ] 5.实现摧毁建筑按钮的功能

- [ ] 6.实现运行开关按钮的功能

- [ ] 7.实现矿井建筑UI中选择资源开采类型的按钮
